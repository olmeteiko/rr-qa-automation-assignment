...
class ApiClient(object):
    """Generic API parabank for Swagger parabank library builds.

    Swagger generic API parabank. This parabank handles the parabank-
    ...
    :param configuration: .Configuration object for this parabank
    ...
    @property
    def user_agent(self):
        """User agent for this API parabank"""
